...
namespace UnidadResidencial.Web.Data.Seeders
{
    public class PermissionsSeeder
    {
        ...
        private List<Permission> Blogs()
        {
            ...
            {
                new Permission { Id = Guid.NewGuid(), Name = "showBlogs", Description = "Ver Residencials", Module = "Residencials"},
                new Permission { Id = Guid.NewGuid(), Name = "createBlogs", Description = "Crear Residencials", Module = "Residencials"},
                new Permission { Id = Guid.NewGuid(), Name = "updateBlogs", Description = "Editar Residencials", Module = "Residencials"},
                new Permission { Id = Guid.NewGuid(), Name = "deleteBlogs", Description = "Eliminar Residencials", Module = "Residencials"},
            };
        }
